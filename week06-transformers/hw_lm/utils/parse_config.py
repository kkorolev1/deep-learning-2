...
from hw_lm.logger import setup_logging
from hw_lm.utils import read_json, write_json, ROOT_PATH
...
class ConfigParser:
    ...
    def get_default_configs(cls):
        config_path = ROOT_PATH / "hw_lm" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))

    @classmethod
    def get_test_configs(cls):
        config_path = ROOT_PATH / "hw_lm" / "tests" / "config.json"
        with config_path.open() as f:
            return cls(json.load(f))
